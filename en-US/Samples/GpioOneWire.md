...
Note what follows below is a bit out of date-  the latest version on Github is a 2 wire operation requiring pin4 as input and pin 5 as output. Read the link above to GITHUB Code and the readme and look at the NEW Schematic schematic.png which requires an extra MOSFET
